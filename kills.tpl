	...
	<div class="boxcontent" style="border-top: 0px;">
		<table width="100%" cellpadding="1" cellspacing="0" border="0" class="header">
			...
			<tr class="line">
				...
				<td width="14"><a href="?p=details&amp;kill={$kill["id"]}">
					<img src="http://image.eveonline.com/InventoryType/{$kill["icon"]}_32.png" alt="" width="14" height="14" class="icon"></a>
				</td>
				...
				<td align="center"><a href="?p=details&amp;kill={$kill["id"]}">
					<div class="mailicon">
						<img src="{$TEMPLATEURL}/images/nil.gif" border="0" title="View killmail" alt="View kill" width="16" height="12"></div>
					</a></td>
			</tr>
			{/foreach}
		</table>
